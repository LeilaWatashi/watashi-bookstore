...
import com.watashi.bookstore.repository.*;
...
public class PedidoDAO implements IDAO {
    ...
    public EntidadeDominio salvar(EntidadeDominio entidade) {
        if(entidade instanceof Pedido){
            ...
            pedido.getItemList().forEach(item -> livroRepository.save(item.getLivro()));
    ...
    public void alterar(EntidadeDominio entidade) {
        if(entidade instanceof Pedido){
            ...
            for (Item item : pedido.getItemList()) {
                item.setLivro(livroRepository.save(item.getLivro()));
            }
