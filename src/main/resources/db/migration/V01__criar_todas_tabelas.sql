...
CREATE TABLE transacao_status_livro (
    tsc_id          SERIAL NOT NULL,
    tsc_motivo      VARCHAR(60) NOT NULL,
    tsc_status_id   INT NOT NULL,
    tsc_livro_id    INT NOT NULL
);
...
ALTER TABLE livro ADD CONSTRAINT livro_pk PRIMARY KEY ( liv_id );
...
ALTER TABLE transacao_status_livro ADD CONSTRAINT transacao_status_livro_pk PRIMARY KEY (tsc_id);

ALTER TABLE grupo_precificacao ADD CONSTRAINT grupo_precificacao_pk PRIMARY KEY (gpr_id);

ALTER TABLE livro
    ADD CONSTRAINT livro_status_fk FOREIGN KEY ( liv_status_id )
...
ALTER TABLE item
    ADD CONSTRAINT item_livro_fk FOREIGN KEY ( itm_livro_id )
...
ALTER TABLE transacao_status_livro
    ADD CONSTRAINT transacao_status_livro_livro_fk FOREIGN KEY ( tsc_livro_id )
        REFERENCES livro ( liv_id );